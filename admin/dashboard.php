        ...
        <div class="col-12">
            ...
            <div class="row mb-4">
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card border-left-primary py-2 h-100" style="min-height: 160px;">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card border-left-success py-2 h-100" style="min-height: 160px;">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="me-auto">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card border-left-warning py-2 h-100" style="min-height: 160px;">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="me-auto">
